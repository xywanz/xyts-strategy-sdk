...
class BinanceSpotRestApi : public BinanceRestApiBase {
 public:
  BinanceSpotRestApi(boost::asio::io_context& ioc, boost::asio::ssl::context& ssl,
                     const std::string& api_key, const std::string& secret_key,
                     const std::string& host = "api.binance.com", const std::string& port = "443");
