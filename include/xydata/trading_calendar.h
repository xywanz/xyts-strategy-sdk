...
class TradingCalendar {
 public:
  ...
  xyu::datetime::date TradingDateShift(const xyu::datetime::date& date, std::ptrdiff_t offset);

  xyu::datetime::date TradingDateShift(const std::string& date_string, std::ptrdiff_t offset) {
    return TradingDateShift(xyu::datetime::date::fromisoformat(date_string), offset);
  }
